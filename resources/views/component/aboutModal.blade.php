...
<div id="editAboutModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <form class="mt-5 flex flex-col items-center w-full" method="POST" action="{{ 'about/updateDesc' }}">
            @csrf
            @method('PUT')
            <b class="title text-center flex justify-self-center">Update About Description:</b>
